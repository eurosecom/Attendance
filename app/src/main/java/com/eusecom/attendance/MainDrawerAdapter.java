...
public class MainDrawerAdapter extends RecyclerView.Adapter<MainDrawerAdapter.ViewHolder> {
    ...
    public MainDrawerAdapter(Context context, String Titles[],int Icons[],String Name,String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
    ...
    public void onBindViewHolder(MainDrawerAdapter.ViewHolder holder, int position) {
        if(holder.Holderid ==1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            holder.setClickListener(new MainDrawerAdapter.ViewHolder.ClickListener() {
                    ...
                    if (isLongClick) {
                        ...
                        switch (pos) {
                            ...
                            case 1:
                                ...
                                if (ustype.equals("99")) {
                                    Intent i = new Intent(mContext, DgAllEmpsAbsMvvmActivity.class);
                            ...
                            case 4:
                                ...
                                Intent i4 = new Intent(mContext, BeaconActivity.class);
                            ...
                            case 5:
                                ...
                                //Intent i5 = new Intent(mContext, DemoDaggerActivity.class);
