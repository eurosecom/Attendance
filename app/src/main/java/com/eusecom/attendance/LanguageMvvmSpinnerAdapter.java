...
public class LanguageMvvmSpinnerAdapter extends ArrayAdapter<Language> {

    public LanguageMvvmSpinnerAdapter(final Context context, final int resource,
    ...
    private View inflateView() {
        ...
        return inflater.inflate(R.layout.language_mvvm_item, null);
    }
