...
public class DgAeaCompListFragment extends Fragment {

    public DgAeaCompListFragment() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((AttendanceApplication) getActivity().getApplication()).dgaeacomponent().inject(this);
