...
import com.eusecom.attendance.PostDetailActivity;
import com.eusecom.attendance.R;
import com.eusecom.attendance.models.Post;
import com.eusecom.attendance.viewholder.PostViewHolder;
import com.google.firebase.database.ValueEventListener;

import java.util.HashMap;
import java.util.Map;

public abstract class IntsListFragment extends Fragment {

    private static final String TAG = "IntsListFragment";
    ...
    public IntsListFragment() {}
    String postxy;
    String postkeydel=null;
            ...
            protected void populateViewHolder(final PostViewHolder viewHolder, final Post model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(PostDetailActivity.EXTRA_POST_KEY, postKey);
                            ...
                            Toast.makeText(getActivity(), "Onclick " + postKey, Toast.LENGTH_SHORT).show();
                ...
                viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        Toast.makeText(getActivity(), "Longclick " + postKey,Toast.LENGTH_SHORT).show();

                        postkeydel = postKey;

                        getDialog(postkeydel);
    ...
    private void getDialog(String postkey) {
        ...
        String textx = getString(R.string.item) + " " + postkeydel;
        ...
        buttonEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                extras.putString("keyx", postkeydel);
