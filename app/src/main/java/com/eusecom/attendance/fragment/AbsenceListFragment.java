...
public abstract class AbsenceListFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Absence, AbsenceViewHolder> mAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Absence, AbsenceViewHolder>(Absence.class, R.layout.item_absence,
                AbsenceViewHolder.class, absencesQuery) {

            @Override
            protected void populateViewHolder(final AbsenceViewHolder viewHolder, final Absence model, final int position) {
