...
public class AllEmpsAbsMvvmActivityEspressoTest {


    @Rule
    public ActivityTestRule<AllEmpsAbsMvvmActivity> mActivityRule = new ActivityTestRule<>(AllEmpsAbsMvvmActivity.class);
    ...
    public void setUp() throws Exception {
        ...
        getApp().getAllEmpsAbsComponent().inject(mActivityRule.getActivity());
